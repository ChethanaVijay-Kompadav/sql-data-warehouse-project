...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO [silver].[crm_prod_info](prd_id, prd_key, prd_cat, prd_nm, prd_cost, prd_line, prd_start_dt, prd_end_dt) 
		SELECT
			prd_id,
		...
		(cid, bdate, GEN)
		SELECT 
		SUBSTRING(cid,4, LEN(cid)) cid, -- Remove 'NAS' prefix if present
		CASE 
